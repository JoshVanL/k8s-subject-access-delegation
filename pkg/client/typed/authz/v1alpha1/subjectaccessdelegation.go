...
type SubjectAccessDelegationInterface interface {
	...
	UpdateStatus(*v1alpha1.SubjectAccessDelegation) (*v1alpha1.SubjectAccessDelegation, error)
...
func (c *subjectAccessDelegations) UpdateStatus(subjectAccessDelegation *v1alpha1.SubjectAccessDelegation) (result *v1alpha1.SubjectAccessDelegation, err error) {
	result = &v1alpha1.SubjectAccessDelegation{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("subjectaccessdelegations").
